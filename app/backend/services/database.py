...
async def initialize_database():
    """Initialize database and create tables with retry support"""
    ...
    try:
        ...
        # The lazy initialization in ensure_initialized will retry on first request
        logger.warning("Application will start without database - lazy initialization will retry on first request")
