...
| `tariffs-presentation.html` | **14 слайдов** — тарифы и монетизация: объявления, жильё, партнёры, DAM ALEM, такси |
...
## Презентация тарифов (монетизация)

**Для внутреннего использования, переговоров с партнёрами и риелторами.**

| Файл | Слайдов |
|------|---------|
| `tariffs-presentation.html` | **14** |

### Открыть

```
file:///C:/Users/User/Documents/GitHub/sortirovka24/docs/presentation/tariffs-presentation.html
```

Фильтры внизу: **Жители** · **Партнёры** · **DAM ALEM** · **Такси/курьер** · **Реклама**

### Содержание (14 слайдов)

| # | Слайд |
|---|-------|
| 1 | Обложка — тарифы платформы |
| 2 | Принципы монетизации |
| 3 | Объявления (300 ₸ + продвижение) |
| 4 | Недвижимость + риелторы |
| 5 | Вакансии + мастера |
| 6 | Партнёры (Старт / Стандарт / Эксклюзив) |
| 7 | DAM ALEM + прогноз дохода |
| 8 | Такси и курьер |
| 9 | Реклама |
| 10 | Что бесплатно для жителей |
| 11 | Прогноз дохода 1 район |
| 12 | План запуска тарифов |
| 13 | Сводная таблица |
| 14 | CTA — контакты |
